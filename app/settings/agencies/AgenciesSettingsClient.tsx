...
export default function AgenciesSettingsClient({ initialAgencies, activeCounts, historyCounts, companyId }: { initialAgencies: any[]; activeCounts: Record<string, number>; historyCounts: Record<string, number>; companyId: string }) {
  ...
  const countFor = (id: string) => (activeCounts[id] || 0) + (historyCounts[id] || 0);
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    ...
                    <span className="text-indigo-600 font-medium">{activeCounts[a.id] || 0} in pipeline</span>
                    {(historyCounts[a.id] || 0) > 0 && <span> · {historyCounts[a.id]} joined</span>}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2">
